...
class Improved_NSGA_III(Root2):
    """
    An improved version of NSGA-III, doesn't remember the paper
    """

    def __init__(self, problem=None, pop_size=10, epoch=2, func_eval=100000, lb=None, ub=None, verbose = None, paras=None):
    ...
    def evolve(self, pop=None, fe_mode=None, epoch=None, g_best=None):
        ...
        # print(len(new_pop), self.pop_size)
