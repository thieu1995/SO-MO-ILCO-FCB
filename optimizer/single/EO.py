...
class BaseEO(Root):
    """
        The original version of: Random Walk Equilibrium Optimization
        Link:
            A random walk equilibrium optimization algorithm
            https://ieeexplore.ieee.org/abstract/document/9131305
    """
    ...
    def make_equilibrium_pool(self, list_equilibrium=None, c_eq5=None):  # make equilibrium pool
        ...
        schedule = matrix_to_schedule(self.problem, c_mean.astype(int))
